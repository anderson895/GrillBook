          ...
          $('#outputTableBody').append(`
            <tr class="hover:bg-[#2B2B2B] transition-colors">
              ...
              <td class="p-3 text-center">
                ...
                <button id="btnRestored" class="removeBtn cursor-pointer bg-green-500 hover:bg-green-600 text-black px-3 py-1 rounded text-xs font-semibold transition"
...
function confirmAction(actionStatus) {
    return Swal.fire({
        title: 'Are you sure?',
        text: `You are about to Restore this reservation.`,
        icon: 'warning',
