...
<nav class="bg-black shadow-lg fixed w-full z-50">
  <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <!-- Logo and Title - FIXED LINK -->
    <div class="flex items-center space-x-3">
      <img src="static/logo.jpg" alt="GrillBook Logo" class="w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-yellow-400">
      <a href="./"><h1 class="text-xl sm:text-2xl font-extrabold text-yellow-400 tracking-wide">GrillBook</h1></a>
    </div>

    <!-- Centered Navigation Links - FIXED PATHS -->
    <div class="hidden md:flex flex-1 justify-center space-x-6 items-center">
      <a href="about.php" class="text-yellow-400 hover:text-white transition duration-300 font-medium">About Us</a>
      <a href="contact.php" class="text-yellow-400 hover:text-white transition duration-300 font-medium">Contact Us</a>
    </div>

    <!-- Login/Register (Right Side) - FIXED PATHS -->
    <div class="hidden md:flex space-x-6 items-center">
      <a href="./login.php" class="text-yellow-400 hover:text-white transition duration-300 font-medium">Login</a>
      <a href="./register.php" class="bg-yellow-400 hover:bg-yellow-300 text-black px-5 py-2 rounded-full font-semibold shadow-md transition duration-300">Register</a>
    </div>
...
<!-- Fullscreen Mobile Menu - FIXED PATHS -->
<div id="mobile-menu" class="md:hidden fixed inset-0 bg-black text-yellow-400 hidden z-40 flex flex-col items-center justify-center space-y-6 px-4 transition duration-300 ease-in-out">
  ...
  <!-- Navigation Buttons - FIXED PATHS -->
  <a href="about.php" class="w-full max-w-xs bg-yellow-400 text-black text-lg py-2 rounded-full font-bold text-center hover:bg-yellow-300 transition">About Us</a>
  <a href="contact.php" class="w-full max-w-xs bg-yellow-400 text-black text-lg py-2 rounded-full font-bold text-center hover:bg-yellow-300 transition">Contact Us</a>
  ...
  <a href="register.php" class="w-full max-w-xs bg-yellow-400 text-black text-lg py-2 rounded-full font-bold text-center hover:bg-yellow-300 transition">Register</a>
</div>
