...
<div class="min-h-screen flex flex-col lg:flex-row">
  <aside id="sidebar" class="bg-[#0D0D0D] shadow-lg w-64 lg:w-1/5 xl:w-1/6 p-6 space-y-6 lg:static fixed inset-y-0 left-0 z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
    ...
    <nav class="space-y-4 text-left text-[#CCCCCC] overflow-y-auto h-[calc(100vh-120px)]">
      ...
      <button hidden id="toggleDeals" class="w-full flex cursor-pointer items-center justify-between text-[#CCCCCC] hover:text-[#FFD700] hover:bg-white/10 px-4 py-2 rounded-md transition-all duration-300">
      ...
      <div hidden id="dealsDropdown" class="ml-8 space-y-2 hidden">
      ...
      <a href="report.php" class="nav-link flex items-center space-x-3 text-[#CCCCCC] hover:text-[#FFD700] hover:bg-white/10 px-4 py-2 rounded-md transition-all duration-300">
