    ...
    <div class="flex justify-between items-center p-6">
        <div class="flex items-center space-x-4">
            <div class="p-4 bg-white rounded-2xl shadow-lg border-2 border-[#d97706]">
                <i class="fas fa-calendar-alt text-[#d97706] text-2xl"></i>
            </div>
            <div>
                <h2 class="text-3xl font-bold text-[#92400e] uppercase tracking-wide high-contrast-text">All Reservations</h2>
                <p class="text-gray-600 xl-text">Manage and monitor restaurant reservations</p>
            </div>
        </div>
        <div class="flex items-center space-x-4">
            <div class="stats-card p-4 rounded-xl">
                <div class="flex items-center gap-2">
                    <span class="text-gray-600 xl-text">Total Reservations:</span>
                    <span id="totalReservations" class="text-[#92400e] font-bold text-xl">0</span>
                </div>
            </div>
            <div class="relative group">
                <button class="p-4 glass-card hover:bg-[#d97706] hover:text-white transition-all duration-300 shadow-lg rounded-2xl" onclick="refreshReservations()">
  ...
  <div class="flex flex-col lg:flex-row gap-4 justify-between items-start lg:items-center">
    ...
    <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
      ...
      <div class="flex gap-2">
        <button onclick="filterReservations('all')" class="filter-btn bg-[#d97706] text-white interactive-hover">
          <i class="fas fa-layer-group mr-2"></i>All
        </button>
        <button onclick="filterReservations('today')" class="filter-btn bg-gray-300 text-gray-800 interactive-hover">
          <i class="fas fa-calendar-day mr-2 icon-primary"></i>Today
        </button>
        <button onclick="filterReservations('pending')" class="filter-btn bg-gray-300 text-gray-800 interactive-hover">
    ...
    <div class="flex items-center space-x-4 text-sm text-gray-400">
      <div class="flex items-center space-x-2 bg-yellow-100 px-3 py-1 rounded-full">
        <i class="fas fa-database text-[#d97706]"></i>
        ...
        <tr>
          <td colspan="9" class="p-8 text-center text-gray-600">
            <div class="flex flex-col items-center justify-center space-y-4">
              ...
              <div>
                <p class="xxl-text font-semibold high-contrast-text">Loading reservation data...</p>
...
<!-- No Results Message -->
<div id="emptyState" class="hidden mt-8 p-12 text-center stats-card rounded-xl">
    <div class="flex flex-col items-center justify-center space-y-6">
        <i class="fas fa-calendar-times text-6xl text-gray-400"></i>
        <div>
            <p class="xxl-text font-semibold high-contrast-text">No reservations found</p>
...
<div id="spinner" class="fixed inset-0 z-50 flex items-center justify-center bg-white/90 backdrop-blur-sm hidden">
    <div class="enhanced-modal p-10 flex flex-col items-center space-y-6">
        ...
        <div class="text-center">
            <p class="xxl-text font-semibold high-contrast-text">Loading Reservations</p>
            <p class="xl-text text-gray-600 mt-2">Please wait while we fetch your data...</p>
        </div>
    </div>
</div>
        ...
        <div class="space-y-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="xl-text text-gray-600">Complete reservation information</p>
                </div>
            </div>
...
function filterReservations(filterType) {
    showEnhancedToast(`Filtering: ${filterType} reservations`, 'info');
...
function refreshReservations() {
    ...
    showEnhancedToast('Refreshing reservations...', 'info');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    showEnhancedToast('Reservations dashboard loaded', 'success');
});

// Export functions for your existing all_reserved.js
...
<script src="../static/js/headstaff/all_reserved.js"></script>